...
export default defineConfig({
  testDir: ".",
  testMatch: ["screenshot-readiness.spec.ts", "service-worker-reload.spec.ts", "lost-send.spec.ts", "chat-restart.spec.ts", "settings-toggle.spec.ts", "browser-bootstrap-diagnostics.spec.ts"],
  workers: 1,
  retries: 0,
  timeout: 10_000,
  use: {
