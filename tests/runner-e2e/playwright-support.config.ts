...
export default defineConfig({
  testDir: ".",
  testMatch: ["screenshot-readiness.spec.ts", "lost-send.spec.ts", "chat-restart.spec.ts", "settings-toggle.spec.ts", "browser-bootstrap-diagnostics.spec.ts", "service-worker-module-loading.spec.ts"],
  workers: 1,
  retries: 0,
  timeout: 10_000,
  use: {
