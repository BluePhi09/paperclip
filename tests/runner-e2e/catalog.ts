...
export const runnerSuites: readonly RunnerSuiteFixture[] = [
  ...
  },
  {
    ...
    definitionMetadata: { version: 7, permissions: "production-defaults", instructions: "production", crashBoundary: "verified-native-worker-pid-at-file-wait", recovery: "new-user-message-after-verified-cleanup", answerGrading: "exact-grounded-propositions-plus-separate-semantic-review", scheduling: "explicit-only" },
  },
