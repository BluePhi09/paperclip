...
| Comments/confident prose/tool calls without state change | Quiet/noisy exhausted repair and failure variants; native event replay | Quiet versus three attributed misleading comments per run; no extra allowance |
